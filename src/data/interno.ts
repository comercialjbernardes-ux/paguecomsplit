...
export const dadosProjecaoBase: DadoProjecao[] = [
...
export const lancamentosMock: LancamentoCusto[] = [
...
export interface ClienteCarteira {
  ...
  ticketMedio: number
  frequenciaCompra: number  // compras por trimestre
}

export const segmentos = ['Todos', 'Varejo', 'Indústria', 'Serviços', 'Tecnologia', 'Agro']

export const clientesCarteira: ClienteCarteira[] = [
