// ═══════════════════════════════════════════════════════════════
// Login — Tela de autenticacao Google OAuth2
// Conforme fluxograma: primeira tela antes de acessar o dashboard
// ═══════════════════════════════════════════════════════════════
        ...
        <div className="max-w-md text-center relative z-10">
          ...
          <div className="space-y-6 text-left">
            <Feature
              ...
              description="Fechamento mensal, metas e ranking de equipe"
            />
            <Feature
              icon={<Database className="w-5 h-5" />}
              title="Dados em Tempo Real"
              description="Conectado diretamente a sua planilha Google Sheets"
            />
            <Feature
              icon={<ShieldCheck className="w-5 h-5" />}
              title="Seguro e Controlado"
              description="Autenticacao Google OAuth2 para acesso protegido"
            />
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-gray-500 mb-8">
              Faca login com sua conta Google para acessar o dashboard
            </p>
          </div>
          ...
          {!isConfigured && (
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
              ...
              <p className="text-xs text-amber-600">
                Configure as variaveis de ambiente VITE_GOOGLE_CLIENT_ID e
                VITE_GOOGLE_API_KEY no arquivo .env para habilitar o login.
                Consulte o README para instrucoes.
              </p>
            </div>
          )}
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-400">
              Projeto open source — Venda Feita Dashboard v2
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex items-start gap-4">
      ...
      <div>
        ...
        <p className="text-sm text-navy-200">{description}</p>
      </div>
    </div>
  )
}
